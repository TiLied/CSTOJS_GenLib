...
public class GenCSharp : ILog
{
	...
	public async Task GenerateCSFromJson(string path, string output)
	{
		...
		*/
		...
		_SB[0].AppendLine("//Ignore files not found.");
		_SB[0].AppendLine("#pragma warning disable CS1589");
		_SB[0].AppendLine("//Ignore 'Cannot convert null literal to non-nullable reference type.'");
